        ...
        adminRoutes={
          <Drawer>
            <Switch>
              ...
              />
              <Route
                path="/admin/claim/response/:claimId"
                component={ResponseClaim}
              />
              <Route
                path="/admin/complaint/response/:complaintId"
                component={ResponseComplaint}
              />
              <Route path="/admin/response" component={AdminViewResponse} />
              <Route
                exact
                path="/admin/claimType"
                component={ViewAdminClaimType}
              />
              <Route
                path="/admin/claimType/create"
                component={CreateClaimType}
              />
              <Route
                path="/admin/claimType/edit/:claimTypeId"
                component={EditClaimType}
              />
              <Route
                exact
                path="/admin/complaintType"
                component={ViewAdminComplaintType}
              />
              <Route
                path="/admin/complaintType/create"
                component={CreateComplaintType}
              />
              <Route
                path="/admin/complaintType/edit/:complaintTypeId"
                component={EditComplaintType}
              />
              <Redirect
                to={{
                  pathname: "/admin/home",
