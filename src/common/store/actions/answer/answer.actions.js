...
export const updateAnswer = (data) => ({
  type: answerActionsLabels.UPDATE_ANSWER,
  payload: data,
});

export const updateAnswerSuccess = (response) => ({
  type: answerActionsLabels.UPDATE_ANSWER_SUCCESS,
  payload: response,
});

export const updateAnswerFailure = (error) => ({
  type: answerActionsLabels.UPDATE_ANSWER_FAILURE,
  payload: error,
});
